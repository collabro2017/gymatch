...
-(void)setupData
{
    _fButtonSize = 50;//circular button width/height
...
-(void)setupUI
{
    ...
    [self.view setBackgroundColor:[UIColor colorWithRed:230.0/255 green:230.0/255 blue:230.0/255 alpha:0.3]];//Transparent color
}
