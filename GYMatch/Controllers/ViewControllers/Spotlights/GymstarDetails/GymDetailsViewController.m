...
- (void)viewDidLoad
{
    ...
    [self.navigationItem setTitle:@"Gym"];
...
- (void)fillDetailsWithSpotlight:(Spotlight *)aSpotlight{
    ...
    NSArray *cLocation = [aSpotlight.clubLocations componentsSeparatedByString:@","];
    locationsLabel.text = [cLocation componentsJoinedByString:@"\n"];
    featuresLabel.text = [aSpotlight.gymFeatures componentsJoinedByString:@"\n"];
...
- (void)adjustAutoLayoutConstraints{
    ...
    bioHeight.constant = [Utility heightForLabel:bioLabel];
    clubFeatureHeight.constant = [Utility heightForLabel:featuresLabel];
    clubLocationHeight.constant = [Utility heightForLabel:locationsLabel];
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section{
    return [self.aSpotlight.team count];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    Team *team = [self.aSpotlight.team objectAtIndex:indexPath.row];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    tDVC.aTeam = [self.aSpotlight.team objectAtIndex:indexPath.row];
//    [self.navigationController pushViewController:tDVC animated:YES];
    [self presentViewController:tDVC animated:YES completion:^{
