...
#import "UserLikeCell/UserLikesCell.h"
...
- (void)viewDidLoad {
    ...
    UINib *nib = [UINib nibWithNibName:kUserLikesCell bundle:nil];
    [self.tableView registerNib:nib forCellReuseIdentifier:kUserLikesCell];
...
- (void)loadData {
    ...
    [uDC gymChatLikesFor:self.gymChat.ID withSuccess:^(NSArray *aLikes) {
        likes = aLikes;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UserLikesCell *cell = [tableView dequeueReusableCellWithIdentifier:kUserLikesCell];
    [cell fillWithLikes:likes[indexPath.row]];
